...
CelestialDocs supports the full range of Markdown syntax in `.markdown` files as well as frontmatter YAML to define metadata such as a tilte and description.
